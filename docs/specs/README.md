...
| [Verification with Jev](2026-09-26-verification-with-jev-design.md) — TypeSafe AI's Jev evaluation model checks research: same-product triage, manual and product-link identity at save; not used to merge field values | Draft · measured on `v5/jev-spike` ($0.064, 537 calls) · 5 phases |
